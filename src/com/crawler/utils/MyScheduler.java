 ...
 * @since 0.2.0
 */
public class MyScheduler extends DuplicateRemovedScheduler implements
	...
	public MyScheduler(String filePath) {
	...
	private void readUrlFile() throws IOException {
		...
		Pattern p = Pattern.compile("/gd/gdList\\?&type=\\d+&page=\\d+");
		try {
